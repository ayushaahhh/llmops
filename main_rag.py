...
# Index Name
index_name = "earnings-call-session2"
...
os.environ['AZURE_OPENAI_EMBEDDING_MODEL_NAME'] = st.secrets["AZURE_OPENAI"]["AZURE_OPENAI_EMBEDDING_MODEL_NAME"]
os.environ['AZURE_OPENAI_DEPLOYMENT'] = st.secrets["AZURE_OPENAI"]["AZURE_OPENAI_DEPLOYMENT"]
os.environ['OPENAI_API_VERSION'] = st.secrets["AZURE_OPENAI"]["OPENAI_API_VERSION"]
...
client = Client()
embeddings = AzureOpenAIEmbeddings(azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),
